...
def dateListGenerator(start, end, delta):
    ...
    return result
datesList=dateListGenerator(datetime.datetime(2014, 7, 22, 00, 00, 00, 00),datetime.datetime(2014, 7, 27, 00, 00, 00, 00),timedelta(days=1))        
...
for date in datesList:
    ...
    for logChunk in foundLogs: 
        ...
        activities=[]
        userFound=bulk.find({'$and':[{'_id':logChunk['uid']}]})
